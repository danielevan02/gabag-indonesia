    ...
    <div className='relative' ref={searchContainerRef}>
      <div className="flex relative items-center w-fit">
        <Input
          ...
          className="py-2 relative text-sm md:text-base w-60 lg:w-52 lg:focus:w-72 transition-all px-4 border border-black rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
